...
export const GET_NEWSLETTER_METHOD: string = 'GetNewsletter';
export const GET_NEWSLETTERS_METHOD: string = 'GetNewsletters';
...
export const EDIT_EXPENSE_METHOD: string = 'EditExpense';
